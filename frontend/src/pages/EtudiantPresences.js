  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const presencesRes = await fetch('http://195.179.229.230:5004/api/etudiant/presences', {
        ...
        const absencesRes = await fetch('http://195.179.229.230:5004/api/etudiant/absences', {
          headers: { Authorization: `Bearer ${token}` }
        });
